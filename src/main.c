...
static noreturn void task1(usize a0, usize a1, usize a2, usize a3)
{
    spin2lock(&uart_lock);
    say_hart(uart0);
    uart_puts(uart0, "hi!");
...
noreturn void main(void)
{
    ...
    hart_task(2, 0, 1, 2, 3, 4, 5, (addr)task1);
    hart_task(3, 1, 2, 3, 4, 5, 0, (addr)task1);
    hart_task(2, 2, 3, 4, 5, 0, 1, (addr)task1);
